...
import logoSmall from '../../assets/wnsIconLogo.svg'
import typedLogo from '../../assets/wns_logo_small.svg'
import typedLogoWhite from '../../assets/wns_logo_white_small.svg'
...
const StickyHeader = styled('header')`
  ...
  background: ${props =>
    props.menuOpen ? 'rgb(13, 19, 22)' : 'rgba(255,255,255,1)'};
...
class StickyHeaderContainer extends React.Component {
  ...
  calculateStyles = (scrollData, menuOpen) => {
    ...
    const internalNavStyle = {
      ...
      borderRight: `1px solid rgba(13,19,22,${stickyOpacity})`,
    }
      ...
      <StickyHeader style={stickyHeaderStyle} menuOpen={this.state.menuOpen}>
        ...
        <div className={`right-nav`} style={rightNavStyle}>
          ...
          <div className="social">
            {
              /*<OutboundLink href="https://twitter.com/wnsdomains">
              <img src={twitter} className="twitter"/>
              <img src={twitterBlack} className="twitter-mobile"/>
            </OutboundLink>
            < OutboundLink href="https://medium.com/the-waves-name-service">
              <img src={medium} className="medium" />
              <img src={mediumBlack} className="medium-mobile" />
              </OutboundLink>
              */
            }
            <OutboundLink href="https://github.com/wnsdomains">
